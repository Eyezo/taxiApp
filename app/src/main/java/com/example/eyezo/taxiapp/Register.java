        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (etName.getText().toString().isEmpty() ||
                        ...
                        etConPassword.getText().toString().isEmpty())
                {
                ...
                else
                {
                    if (etPassword.getText().toString().trim().equals(etConPassword.getText().toString().trim()))
                    {
                        ...
                        String b = String.valueOf(numOfPass);
                  ...
                  /**      BackendlessUser user = new BackendlessUser();
                        ...
                        user.setProperty("amount", a);
                        user.setProperty("numofpass", b);
                    ...
                    {
                        Toast.makeText(Register.this, "Please make sure PASSWORD matches RE-ENTER PASSWORD", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
